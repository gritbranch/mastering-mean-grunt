module.exports = function(grunt) {
  //grunt.initConfig() method to configure your third-party tasks. 
  grunt.initConfig({
    env: {
      test: {
        NODE_ENV: 'test'
...
//grunt.registerTask() method accepts two arguments: the first one sets the task name 
//and the second argument is a collection of other grunt tasks that will be executed when the parent task is used.
